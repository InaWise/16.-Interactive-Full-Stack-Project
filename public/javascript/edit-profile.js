...
const imgContainer = document.getElementById('Profile');
let idData = '';
async function createNewUserHandler(event) {
    ...
    event.preventDefault();
    const username = "Thjghfghhasrwe";
    const email = "oyuoybvbvcbvcbcvbulkjh@example.com";
                ...
                */
                ...
                if (fileType === 'png' || fileType === 'jpg' || fileType === 'jpeg' || fileType === 'gif') {
                    if (fileData.size > 2 * 1024 * 1024) {
                        ...
                        const imageUpload = await fetch('api/users/profile/:id', {
                            method: 'put',
                            body: formData,
                        }).catch(e => {
                            console.log(e)
